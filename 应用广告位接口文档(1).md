...
source_app_id | string |  是 | 源应用ID，需填写您自己平台的应用ID。
...
source_unit_id | string |  是 | 源广告位ID，需填写您自己平台的广告位ID。
...
app_id | string | 可玩广告平台为该应用生成的应用id
ad_unit_id | string | 可玩广告平台为该广告位生成的广告位id
