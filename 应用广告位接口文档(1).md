...
source_app_id | string |  是 | 源应用ID
app_name | string |  是 | 应用名称，100字符以内
package_name | string |  是 | 应用包名，100字符以内
category | string |  是 | 应用分类，需填写英文，具体值请见[应用分类列表](#3-应用分类)
download_url | string |  否 | 应用下载地址，若填值，必须是http/https链接
app_store | int |  是 | 应用商店，需填写ID，具体值请见[应用商店列表](#4-应用商店)
industry_filter | string |  否 | 该流量应用屏蔽的投放应用分类。若填值，需填写英文，具体值请见[应用分类列表](#3-应用分类)
unit_id | string |  是 | 源广告位ID
